...
export const AddCitizen = ({ 
  ...
  const handleNewCitizenCreated = (citizen: Citizen) => {
      ...
      <>
        <div className="bg-white rounded-lg shadow-sm border p-4">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <CitizenSearch
                  ...
                  onNewCitizenClick={() => setShowNewCitizenModal(true)}
            ...
            {/* Show remaining steps only after citizen is selected */}
            {selectedCitizen && (
              <>
        ...
        <NewCitizenModal
          open={showNewCitizenModal}
          onOpenChange={setShowNewCitizenModal}
          onCitizenCreated={handleNewCitizenCreated}
        />
      </>
    );
  }
    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Incluir Munícipe na Fila</DialogTitle>
          </DialogHeader>
