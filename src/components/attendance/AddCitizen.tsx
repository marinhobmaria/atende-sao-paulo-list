...
export const AddCitizen = ({ queueCount, waitingCount, statusCounts, filters, setFilters }: AddCitizenProps) => {
  ...
  const handleQueueFilter = () => {
    // Reset all filters to show entire queue
    setFilters({
      ...filters,
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button
              onClick={handleQueueFilter}
              className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded-lg font-medium text-sm transition-all duration-200 cursor-pointer border-2 border-transparent"
            >
              Fila: {queueCount}
            </button>
          ...
          <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogTrigger asChild>
              <Button className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700" size="sm">
